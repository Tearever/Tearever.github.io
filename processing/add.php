...
?>
<form action="add_processing.php" method="POST">
    <label>Username</label><br>
    <input type='text' name='username' class="w3-border w3-border-black">
    <br></br>
    <label>password</label><br>
    <input type='password' name='password' class="w3-border w3-border-black">
    <br></br>
    <input type="submit" value="ADD" class="w3-border w3-border-black">
    <br></br>
